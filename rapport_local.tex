...
Pour caractériser ses variations sans trop présumer de leur nature, nous avons simplement regardé la moyenne et la dispersion des incréments $\Delta X_t = X_{t+dt} - X_t$. Ils auraient l'allure d'un bruit centré de faible amplitude, de moyenne de l'ordre de $-3\cdot 10^{-4}$ et d'écart-type de l'ordre de $6\cdot 10^{-3}$. Le virus lui-même paraîtrait donc non stationnaire sur la fenêtre observée alors que ses variations sembleraient l'être. Distinguer plus finement sa structure, par exemple une marche aléatoire d'un retour à la moyenne très lent, demanderait bien plus que ces quelques échantillons et reste pour l'instant une question ouverte.
