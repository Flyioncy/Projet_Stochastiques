...
Le tableau~\ref{tab:stats} résume la moyenne et l'écart-type du virus et de ses incréments. Les incréments $\Delta X_t = X_{t+dt} - X_t$ ont une moyenne quasi nulle et un faible écart-type, ce qui leur donne l'allure d'un bruit centré de petite amplitude.
