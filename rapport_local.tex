...
Un test de Kolmogorov-Smirnov donne ici une p-value de l'ordre de $6\cdot10^{-14}$. \textbf{À priori, l'hypothèse d'une distribution gaussienne des différences n'est pas retenue.}
...
On simule alors $X_t = \nu\,t + \sigma\,B_t$ à partir d'un mouvement brownien. Le test de Kolmogorov-Smirnov entre le $X$ simulé et le $X$ reconstruit donne une p-value moyenne de l'ordre de $10^{-9}$ sur de nombreuses simulations.

Cette p-value est très inférieure à $0{,}05$. \textbf{À priori, le brownien avec dérive n'est pas retenu.}
...
où l'intégrale d'Itô est approchée par une somme sur les incréments du brownien. Le test de Kolmogorov-Smirnov donne une p-value moyenne de l'ordre de $10^{-7}$.

Cette p-value est elle aussi très inférieure à $0{,}05$. \textbf{À priori, l'Ornstein-Uhlenbeck n'est pas retenu.}
