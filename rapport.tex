...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\textwidth]{virus4_sim_derive.png}
  \caption{Trois trajectoires simulées du brownien avec dérive (en gris) et le virus reconstruit.}
...
\begin{figure}[ht]
  ...
  \caption{Trois trajectoires simulées de l'Ornstein-Uhlenbeck (en gris) et le virus reconstruit.}
  \label{fig:sim-ou}
\end{figure}
