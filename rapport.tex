...
\begin{table}[ht]
  ...
  \begin{tabular}{lcc}
    ...
    \hline
    $X_t$ & $-0{,}40$ & $0{,}23$ \\
    $\Delta X_t$ & $-3\cdot 10^{-4}$ & $6\cdot 10^{-3}$ \\
    \hline
  \end{tabular}
  \caption{Moyenne et écart-type empiriques du virus reconstruit $X_t$ et de ses incréments $\Delta X_t$.}
  \label{tab:stats}
\end{table}

Sa moyenne empirique vaut environ $-0{,}40$, donc négative, ce qui irait dans le sens de notre hypothèse sur l'équilibre. Avec une seule trajectoire de $2000$ points il faut toutefois rester prudent et se contenter de dégager des tendances. Le virus semblerait partir de $X_0 \approx 0$ puis décroître jusque vers $-0{,}6$ aux alentours de $t \approx 13$ avant de fluctuer autour de ce niveau. Ses incréments $\Delta X_t = X_{t+dt} - X_t$ ont une moyenne quasi nulle et un faible écart-type, ce qui leur donne l'allure d'un bruit centré de petite amplitude.
